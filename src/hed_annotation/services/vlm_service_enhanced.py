"""Enhanced VLM Service with comprehensive metrics using LangChain ChatOllama."""
...
class VLMResult(BaseModel):
    """Enhanced result from a VLM annotation with comprehensive metrics."""
...
class VLMServiceEnhanced:
    """Enhanced VLM service with comprehensive metrics collection."""
    ...
    def __init__(
        ...
        """Initialize the enhanced VLM service.
...
def save_results(results: list[VLMResult], output_dir: str | Path) -> Path:
    """Save enhanced annotation results to JSON file.
    ...
    output_file = output_dir / f"vlm_annotations_enhanced_{timestamp}.json"
...
def main():
    """Test the enhanced VLM service with comprehensive metrics."""
    print("=" * 60)
    print("Enhanced VLM Service Test with Metrics")
    print("=" * 60)
    ...
    # Create service
    service = VLMServiceEnhanced(model="gemma3:4b", temperature=0.7)
